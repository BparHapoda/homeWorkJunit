...
storage.printStorage();
    ...
    public static void createStorage(Storage storage){
        storage.add(new Item("огурцы",10.5,Units.KG.name(), storage.generateBarcode(),null));
        storage.add(new Item("помидоры",1.9,Units.KG.name(), storage.generateBarcode(),null));
        storage.add(new Item("ананас",0.5,Units.PIECE.name(), storage.generateBarcode(),null));
        storage.add(new Item("хрен",110.5, Units.KG.name(), storage.generateBarcode(),null));
        storage.add(new Item("корица",1110.5, Units.GRAMM.name(), storage.generateBarcode(),null));
        storage.add(new Item("молоко",11.5, Units.LITER.name(), storage.generateBarcode(),null));
        storage.save();
    }
}